    ...
    return `
      ...
      <legend>Update Bookmark</legend>
        <div class='col-6'>
          ...
          <li class='new-item-li'><input type='text' id='js-form-title' name='title' placeholder='Whatchamacallit'></li>

          <!-- Description -->
          <label for='js-form-description'>Description</label>
          <li class='new-item-li'><textarea id='js-form-description' name='description' placeholder="chewy chocolatey crunchy munchy!"></textarea>
        </div>
        <div class='col-6'>
        <!-- URL -->
